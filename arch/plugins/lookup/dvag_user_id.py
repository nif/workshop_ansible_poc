...
DOCUMENTATION = r"""
  ...
  version_added: "0.1" 
  short_description: get uid from dvag_conf/user_id.yml
  description:
      - This lookup returns tuid from dvag_conf/user_id.yml
  options:
    _terms:
...
class LookupModule(LookupBase):
    ...
    def run(self, terms, variables=None, **kwargs):
      ...
      user_id_file = 'dvag_conf/user_id.yml'
      ...
      try:
        ...
        raise AnsibleError(f"ERROR parsing yaml file  <{user_id_file}>: {err}")
      ...
      for term in terms:
          ...
          try:
            ...
            raise AnsibleError(f"ERROR getting uid for user <{term}> from <{user_id_file}>: {err}")
